...
function lovechange(n){
    ...
    if(n == 1){
        if( h1 % 2 == 0){
            $("#love1").css("background", "url(images/heart2.png)");
            h1++;
            // alert("if: ");
        } else{
            $("#love1").css("background", "url(images/heart1.png)");
            h1++;
            // alert("else: ");
        }
        ...
        if( h2 % 2 == 0){
            $("#love2").css("background", "url(images/heart2.png)");
            h2++;
        } else{
            $("#love2").css("background", "url(images/heart1.png)");
            h2++;
        }
        ...
        if( h3 % 2 == 0){
            $("#love3").css("background", "url(images/heart2.png)");
            h3++;
        } else{
            $("#love3").css("background", "url(images/heart1.png)");
            h3++;
        }
